...
INSERT INTO [C_REST_ROUTE] ([ROUTE_GUID], [ROUTE_URL]) VALUES ('{a6ee27e4-8ea8-4f00-8e77-f1556397ce31}', '/{account}/incidents/{id}/documents');
INSERT INTO [C_REST_HANDLER_REFERENCE] ([REFERENCE_GUID], [HANDLER]) VALUES (
...
INSERT INTO [C_REST_ROUTE] ([ROUTE_GUID], [ROUTE_URL]) VALUES ('{ebc2f716-1018-4b15-9121-f3e1d054a428}', '/{account}/incidents/{id}/actions');
INSERT INTO [C_REST_HANDLER_REFERENCE] ([REFERENCE_GUID], [HANDLER]) VALUES (
...
INSERT INTO [C_REST_ROUTE] ([ROUTE_GUID], [ROUTE_URL]) VALUES ('{e90e8b0d-4423-4b59-b6e4-f5df6884d45b}', '/{account}/incidents/{id}/tasks');
INSERT INTO [C_REST_HANDLER_REFERENCE] ([REFERENCE_GUID], [HANDLER]) VALUES (
                                        '{09687222-8281-494e-88c1-b689418f2cf2}',
                                        'Evsm\App\Api\processHandler\external\post\RestPostTaskToRequestProcessHandler'
                                        );
INSERT INTO [C_REST_ROUTE] ([ROUTE_GUID], [ROUTE_URL]) VALUES ('{a9aa59a2-04c4-4990-82f8-d0df564646ff}', '/{account}/incidents/{id}/countDocuments');
INSERT INTO [C_REST_HANDLER_REFERENCE] ([REFERENCE_GUID], [HANDLER]) VALUES (
                                        '{18f30d20-6837-411a-b491-719783df255a}',
                                        'Evsm\App\Api\processHandler\external\get\RestGetCountDocumentsProcessHandler'
                                        );
INSERT INTO [C_REST_ROUTE] ([ROUTE_GUID], [ROUTE_URL]) VALUES ('{a4dad2f6-46c3-4f50-b0d5-bde4dd3b72f9}', '/{account}/incidents/{id}/close');
INSERT INTO [C_REST_HANDLER_REFERENCE] ([REFERENCE_GUID], [HANDLER]) VALUES (
                                        '{0a00b671-0104-473e-b016-9a181e164616}',
                                        'Evsm\App\Api\processHandler\external\update\RestCloseRequestProcessHandler'
                                        );
INSERT INTO [C_REST_ROUTE] ([ROUTE_GUID], [ROUTE_URL]) VALUES ('{d5591b24-1f3d-4585-bfa8-77f693d5f600}', '/{account}/incidents/{id}/suspend');
INSERT INTO [C_REST_HANDLER_REFERENCE] ([REFERENCE_GUID], [HANDLER]) VALUES (
                                        '{614e2f4e-4fbe-4df9-8a01-014a107280d9}',
                                        'Evsm\App\Api\processHandler\external\update\RestSuspendRequestProcessHandler'
                                        );
INSERT INTO [C_REST_ROUTE] ([ROUTE_GUID], [ROUTE_URL]) VALUES ('{d92529c7-bdde-406a-8ccf-b2ec648b764a}', '/{account}/incidents/{id}/restart');
INSERT INTO [C_REST_HANDLER_REFERENCE] ([REFERENCE_GUID], [HANDLER]) VALUES (
                                        '{22f495fd-a3e5-43f4-8146-16d19b1c4ebe}',
                                        'Evsm\App\Api\processHandler\external\update\RestRestartRequestProcessHandler'
                                        );
INSERT INTO [C_REST_ROUTE] ([ROUTE_GUID], [ROUTE_URL]) VALUES ('{f3755f29-78bd-4f89-970e-a43cc638bdfd}', '/{account}/incidents/{id}/problem');
INSERT INTO [C_REST_HANDLER_REFERENCE] ([REFERENCE_GUID], [HANDLER]) VALUES (
...
INSERT INTO [C_REST_RESOURCE_ROUTE] ([RESOURCE_ID],
    ...
    [RESOURCE_ROUTE_NAME_GE] ,
    [RESOURCE_ROUTE_NAME_IT] ,
   [RESOURCE_ROUTE_NAME_PO]) VALUES ((SELECT [RESOURCE_ID] FROM [C_REST_RESOURCE] WHERE ([RESOURCE_NAME] LIKE 'ASSET_CHARACTERISTICS' OR [RESOURCE_NAME] = 'ASSET_CHARACTERISTIC')  AND [RESOURCE_NAME] NOT LIKE 'ASSET_CHARACTERISTIC%[_]%'), (SELECT [ROUTE_ID] FROM [C_REST_ROUTE] WHERE [ROUTE_GUID] = '{7f1b0902-0776-484f-8471-4722d35bd19b}'), '{de971c32-11bd-43dc-bfdc-f70f7f5cbb46}' ,'/{account}/asset_characteristics/{id}',
  '[/{account}/asset_characteristics/{id}]',
   '[/{account}/asset_characteristics/{id}]',
   '[/{account}/asset_characteristics/{id}]',
   '[/{account}/asset_characteristics/{id}]',
   '[/{account}/asset_characteristics/{id}]');
...
INSERT INTO [C_REST_RESOURCE_ROUTE] ([RESOURCE_ID],
    ...
    [RESOURCE_ROUTE_NAME_GE] ,
    [RESOURCE_ROUTE_NAME_IT] ,
   [RESOURCE_ROUTE_NAME_PO]) VALUES ((SELECT [RESOURCE_ID] FROM [C_REST_RESOURCE] WHERE ([RESOURCE_NAME] LIKE 'INCIDENTS' OR [RESOURCE_NAME] = 'INCIDENT')  AND [RESOURCE_NAME] NOT LIKE 'INCIDENT%[_]%'), (SELECT [ROUTE_ID] FROM [C_REST_ROUTE] WHERE [ROUTE_GUID] = '{731fc5ce-2e3f-4c12-ba0b-2cab27e3809f}'), '{1fa1a727-9463-4d63-80a0-41377b49cf0c}' ,'/{account}/incidents',
  '[/{account}/incidents]',
   '[/{account}/incidents]',
   '[/{account}/incidents]',
   '[/{account}/incidents]',
...
INSERT INTO [C_REST_RESOURCE_ROUTE] ([RESOURCE_ID],
    ...
    [RESOURCE_ROUTE_NAME_GE] ,
    [RESOURCE_ROUTE_NAME_IT] ,
   [RESOURCE_ROUTE_NAME_PO]) VALUES ((SELECT [RESOURCE_ID] FROM [C_REST_RESOURCE] WHERE ([RESOURCE_NAME] LIKE 'INCIDENTS' OR [RESOURCE_NAME] = 'INCIDENT')  AND [RESOURCE_NAME] NOT LIKE 'INCIDENT%[_]%'), (SELECT [ROUTE_ID] FROM [C_REST_ROUTE] WHERE [ROUTE_GUID] = '{7f1b0902-0776-484f-8471-4722d35bd19b}'), '{437bc7da-17ee-436b-a1e4-ffb5f0becf47}' ,'/{account}/incidents/{id}',
...
INSERT INTO [C_REST_RESOURCE_ROUTE] ([RESOURCE_ID],
    ...
    [RESOURCE_ROUTE_NAME_GE] ,
    [RESOURCE_ROUTE_NAME_IT] ,
   [RESOURCE_ROUTE_NAME_PO]) VALUES ((SELECT [RESOURCE_ID] FROM [C_REST_RESOURCE] WHERE ([RESOURCE_NAME] LIKE 'INCIDENTS' OR [RESOURCE_NAME] = 'INCIDENT')  AND [RESOURCE_NAME] NOT LIKE 'INCIDENT%[_]%'), (SELECT [ROUTE_ID] FROM [C_REST_ROUTE] WHERE [ROUTE_GUID] = '{a6ee27e4-8ea8-4f00-8e77-f1556397ce31}'), '{d4830ee7-80d7-4ad6-9dcd-fc8f6767e423}' ,'/{account}/incidents/{id}/documents',
  '[/{account}/incidents/{id}/documents]',
   '[/{account}/incidents/{id}/documents]',
   '[/{account}/incidents/{id}/documents]',
   '[/{account}/incidents/{id}/documents]',
   '[/{account}/incidents/{id}/documents]');
INSERT INTO [C_REST_RESOURCE_ROUTE] ([RESOURCE_ID],
    ...
    [RESOURCE_ROUTE_NAME_GE] ,
    [RESOURCE_ROUTE_NAME_IT] ,
   [RESOURCE_ROUTE_NAME_PO]) VALUES ((SELECT [RESOURCE_ID] FROM [C_REST_RESOURCE] WHERE ([RESOURCE_NAME] LIKE 'INCIDENTS' OR [RESOURCE_NAME] = 'INCIDENT')  AND [RESOURCE_NAME] NOT LIKE 'INCIDENT%[_]%'), (SELECT [ROUTE_ID] FROM [C_REST_ROUTE] WHERE [ROUTE_GUID] = '{ebc2f716-1018-4b15-9121-f3e1d054a428}'), '{ae5a8dd7-c3cc-4732-9363-1f95167aa61f}' ,'/{account}/incidents/{id}/actions',
  '[/{account}/incidents/{id}/actions]',
   '[/{account}/incidents/{id}/actions]',
   '[/{account}/incidents/{id}/actions]',
   '[/{account}/incidents/{id}/actions]',
   '[/{account}/incidents/{id}/actions]');
INSERT INTO [C_REST_RESOURCE_ROUTE] ([RESOURCE_ID],
    ...
    [RESOURCE_ROUTE_NAME_GE] ,
    [RESOURCE_ROUTE_NAME_IT] ,
   [RESOURCE_ROUTE_NAME_PO]) VALUES ((SELECT [RESOURCE_ID] FROM [C_REST_RESOURCE] WHERE ([RESOURCE_NAME] LIKE 'INCIDENTS' OR [RESOURCE_NAME] = 'INCIDENT')  AND [RESOURCE_NAME] NOT LIKE 'INCIDENT%[_]%'), (SELECT [ROUTE_ID] FROM [C_REST_ROUTE] WHERE [ROUTE_GUID] = '{e90e8b0d-4423-4b59-b6e4-f5df6884d45b}'), '{d2a8a591-8c60-420a-9a80-362305f8c774}' ,'/{account}/incidents/{id}/tasks',
  '[/{account}/incidents/{id}/tasks]',
   '[/{account}/incidents/{id}/tasks]',
   '[/{account}/incidents/{id}/tasks]',
   '[/{account}/incidents/{id}/tasks]',
   '[/{account}/incidents/{id}/tasks]');
INSERT INTO [C_REST_RESOURCE_ROUTE] ([RESOURCE_ID],
    ...
    [RESOURCE_ROUTE_NAME_GE] ,
    [RESOURCE_ROUTE_NAME_IT] ,
   [RESOURCE_ROUTE_NAME_PO]) VALUES ((SELECT [RESOURCE_ID] FROM [C_REST_RESOURCE] WHERE ([RESOURCE_NAME] LIKE 'INCIDENTS' OR [RESOURCE_NAME] = 'INCIDENT')  AND [RESOURCE_NAME] NOT LIKE 'INCIDENT%[_]%'), (SELECT [ROUTE_ID] FROM [C_REST_ROUTE] WHERE [ROUTE_GUID] = '{a9aa59a2-04c4-4990-82f8-d0df564646ff}'), '{35a9bc4c-30c7-44f7-be08-6e4d852b1112}' ,'/{account}/incidents/{id}/countDocuments',
  '[/{account}/incidents/{id}/countDocuments]',
   '[/{account}/incidents/{id}/countDocuments]',
   '[/{account}/incidents/{id}/countDocuments]',
   '[/{account}/incidents/{id}/countDocuments]',
...
INSERT INTO [C_REST_RESOURCE_ROUTE] ([RESOURCE_ID],
    ...
    [RESOURCE_ROUTE_NAME_GE] ,
    [RESOURCE_ROUTE_NAME_IT] ,
   [RESOURCE_ROUTE_NAME_PO]) VALUES ((SELECT [RESOURCE_ID] FROM [C_REST_RESOURCE] WHERE ([RESOURCE_NAME] LIKE 'INCIDENTS' OR [RESOURCE_NAME] = 'INCIDENT')  AND [RESOURCE_NAME] NOT LIKE 'INCIDENT%[_]%'), (SELECT [ROUTE_ID] FROM [C_REST_ROUTE] WHERE [ROUTE_GUID] = '{a4dad2f6-46c3-4f50-b0d5-bde4dd3b72f9}'), '{141cc884-82d5-49ad-842e-64dccb89bc42}' ,'/{account}/incidents/{id}/close',
  '[/{account}/incidents/{id}/close]',
   '[/{account}/incidents/{id}/close]',
   '[/{account}/incidents/{id}/close]',
   '[/{account}/incidents/{id}/close]',
   '[/{account}/incidents/{id}/close]');
INSERT INTO [C_REST_RESOURCE_ROUTE] ([RESOURCE_ID],
    ...
    [RESOURCE_ROUTE_NAME_GE] ,
    [RESOURCE_ROUTE_NAME_IT] ,
   [RESOURCE_ROUTE_NAME_PO]) VALUES ((SELECT [RESOURCE_ID] FROM [C_REST_RESOURCE] WHERE ([RESOURCE_NAME] LIKE 'INCIDENTS' OR [RESOURCE_NAME] = 'INCIDENT')  AND [RESOURCE_NAME] NOT LIKE 'INCIDENT%[_]%'), (SELECT [ROUTE_ID] FROM [C_REST_ROUTE] WHERE [ROUTE_GUID] = '{d5591b24-1f3d-4585-bfa8-77f693d5f600}'), '{c26d2992-5e41-43b5-ad34-5a1a99ecd26d}' ,'/{account}/incidents/{id}/suspend',
  '[/{account}/incidents/{id}/suspend]',
   '[/{account}/incidents/{id}/suspend]',
   '[/{account}/incidents/{id}/suspend]',
   '[/{account}/incidents/{id}/suspend]',
   '[/{account}/incidents/{id}/suspend]');
INSERT INTO [C_REST_RESOURCE_ROUTE] ([RESOURCE_ID],
    ...
    [RESOURCE_ROUTE_NAME_GE] ,
    [RESOURCE_ROUTE_NAME_IT] ,
   [RESOURCE_ROUTE_NAME_PO]) VALUES ((SELECT [RESOURCE_ID] FROM [C_REST_RESOURCE] WHERE ([RESOURCE_NAME] LIKE 'INCIDENTS' OR [RESOURCE_NAME] = 'INCIDENT')  AND [RESOURCE_NAME] NOT LIKE 'INCIDENT%[_]%'), (SELECT [ROUTE_ID] FROM [C_REST_ROUTE] WHERE [ROUTE_GUID] = '{d92529c7-bdde-406a-8ccf-b2ec648b764a}'), '{4d715fb2-87ef-4c12-a775-574e52ff88d9}' ,'/{account}/incidents/{id}/restart',
  '[/{account}/incidents/{id}/restart]',
   '[/{account}/incidents/{id}/restart]',
   '[/{account}/incidents/{id}/restart]',
   '[/{account}/incidents/{id}/restart]',
...
INSERT INTO [C_REST_RESOURCE_ROUTE] ([RESOURCE_ID],
    ...
    [RESOURCE_ROUTE_NAME_GE] ,
    [RESOURCE_ROUTE_NAME_IT] ,
   [RESOURCE_ROUTE_NAME_PO]) VALUES ((SELECT [RESOURCE_ID] FROM [C_REST_RESOURCE] WHERE ([RESOURCE_NAME] LIKE 'INCIDENTS' OR [RESOURCE_NAME] = 'INCIDENT')  AND [RESOURCE_NAME] NOT LIKE 'INCIDENT%[_]%'), (SELECT [ROUTE_ID] FROM [C_REST_ROUTE] WHERE [ROUTE_GUID] = '{f3755f29-78bd-4f89-970e-a43cc638bdfd}'), '{ff0bf2f6-90fb-494f-bd50-252a7ef0936e}' ,'/{account}/incidents/{id}/problem',
  '[/{account}/incidents/{id}/problem]',
   '[/{account}/incidents/{id}/problem]',
   '[/{account}/incidents/{id}/problem]',
   '[/{account}/incidents/{id}/problem]',
   '[/{account}/incidents/{id}/problem]');
...
INSERT INTO [C_REST_HANDLER] ([HANDLER_GUID], [HANDLER_REFERENCE_ID], [RESOURCE_ROUTE_GUID], [METHOD_ID]) VALUES (
                                        '{a944a227-c199-4023-85cf-f7a992d361b6}',
                                        (SELECT [REFERENCE_ID] FROM [C_REST_HANDLER_REFERENCE] WHERE [REFERENCE_GUID] = '{472d648b-18ee-4fa7-8aa6-5cefd8b2a7ed}'),
...
INSERT INTO [C_REST_HANDLER] ([HANDLER_GUID], [HANDLER_REFERENCE_ID], [RESOURCE_ROUTE_GUID], [METHOD_ID]) VALUES (
                                        '{cb36775e-66e3-416b-8938-635b48de8a54}',
                                        (SELECT [REFERENCE_ID] FROM [C_REST_HANDLER_REFERENCE] WHERE [REFERENCE_GUID] = '{a5cf4ee1-8baf-4927-83c4-72b3e6b11d2c}'),
                                        '{1fa1a727-9463-4d63-80a0-41377b49cf0c}',
                                        (SELECT [METHOD_ID] FROM [C_REST_METHOD] WHERE [METHOD_GUID] = '{9E264B27-B09B-4836-97FB-E16E51BB7C2C}')
                                        );
INSERT INTO [C_REST_HANDLER] ([HANDLER_GUID], [HANDLER_REFERENCE_ID], [RESOURCE_ROUTE_GUID], [METHOD_ID]) VALUES (
                                        '{cdc9de47-87f8-4259-91e2-df2d23fd877f}',
                                        (SELECT [REFERENCE_ID] FROM [C_REST_HANDLER_REFERENCE] WHERE [REFERENCE_GUID] = '{4c74c3be-79de-4ee7-8ac3-4294df74d88b}'),
                                        '{1fa1a727-9463-4d63-80a0-41377b49cf0c}',
                                        (SELECT [METHOD_ID] FROM [C_REST_METHOD] WHERE [METHOD_GUID] = '{B4474BE1-C1B6-4534-A214-EA8C822BAAD1}')
                                        );
INSERT INTO [C_REST_HANDLER] ([HANDLER_GUID], [HANDLER_REFERENCE_ID], [RESOURCE_ROUTE_GUID], [METHOD_ID]) VALUES (
                                        '{c251085a-e78f-4458-a34b-75dd0c803964}',
                                        (SELECT [REFERENCE_ID] FROM [C_REST_HANDLER_REFERENCE] WHERE [REFERENCE_GUID] = '{472d648b-18ee-4fa7-8aa6-5cefd8b2a7ed}'),
