UPDATE C_REST_RESOURCE
SET XML = '<?xml version="1.0" encoding="UTF-8"?>
<resource name="ASSET_CHARACTERISTIC">
    <table name="AM_ASSET_CHARACTERISTICS" selector="ASSET_ID" selector2="CHARACTERISTIC_ID" alias="ASSET_CHARACTERISTIC"/>
...
WHERE RESOURCE_GUID = '{d3184177-b653-4b4b-b86d-97ffd43c70db}';
UPDATE C_REST_RESOURCE
SET XML = '<?xml version="1.0" encoding="UTF-8"?>
	<resource name="NEW">
...
'
WHERE RESOURCE_GUID = '{be836df4-775a-4b90-8ba4-ebcc6cd87732}'
...
SET XML = '<?xml version="1.0" encoding="UTF-8"?>
<resource name="ASSET">
    <table name="AM_ASSET" selector="ASSET_ID" alias="ASSET"/>

    <query>
        SELECT @@SELECT_FIELDS@@ from AM_ASSET ASSET
        INNER JOIN AM_LOCATION LOCATION ON LOCATION.LOCATION_ID = ASSET.LOCATION_ID
        INNER JOIN AM_DEPARTMENT DEPARTMENT ON DEPARTMENT.DEPARTMENT_ID = ASSET.DEPARTMENT_ID
        LEFT OUTER JOIN AM_EMPLOYEE EMPLOYEE ON EMPLOYEE.EMPLOYEE_ID = ASSET.EMPLOYEE_ID
        LEFT OUTER JOIN AM_CATALOG CATALOG_ASSET ON CATALOG_ASSET.CATALOG_ID = ASSET.CATALOG_ID
        @@WHERE_CLAUSE@@
        @@ORDER_BY_CLAUSE@@
    </query>

    <linkedResources>
        <resource name="LOCATION" target="LOCATION"/>
        <resource name="DEPARTMENT" target="DEPARTMENT"/>
        <resource name="EMPLOYEE" target="EMPLOYEE"/>
        <resource name="CATALOG_ASSET" target="CATALOG_ASSET"/>
    </linkedResources>
    ...
    <excerptFields>
        ...
        <field name="END_OF_WARANTY"/>
        <field name="INSTALLATION_DATE"/>
        <field name="PURCHASE_DATE"/>
    </excerptFields>

</resource>'
WHERE RESOURCE_GUID = '{d6308c15-5142-4f99-b527-152265494087}'
